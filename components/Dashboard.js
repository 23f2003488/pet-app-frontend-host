const Dashboard = {
    ...
    <div class="dashboard-container" :style="{ backgroundImage: 'url(' + dashboardBackground + ')' }">
      ...
      <div v-else>
        ...
        <div class="pet-container">
          ...
          <img v-for="gift in equippedOverlayGifts" :key="gift.id" 
               :class="['accessory-image', gift.name.toLowerCase().includes('bone') ? 'bone-image' : 'overlay-gift-image']" 
               :src="gift.url" />
        </div>
  ...
  methods: {
    async handleLogout() {
      ...
      localStorage.removeItem('equippedOverlayGifts');
  ...
  mounted() {
    ...
    const equippedOverlayGifts = localStorage.getItem('equippedOverlayGifts');
    ...
    else if (equippedCostumeUrl) { this.petImage = equippedCostumeUrl; }

    if (equippedBallUrl) { this.equippedBallUrl = equippedBallUrl; }
    if (equippedBowlUrl) { this.equippedBowlUrl = equippedBowlUrl; }
    if (equippedOverlayGifts) { this.equippedOverlayGifts = JSON.parse(equippedOverlayGifts); }
